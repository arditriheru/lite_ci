    ...
    <div class="animated fadeIn">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped">
                          <thead>
                            <tr>
                                ...
                                <th scope="col"><center>Hari, Jam</center></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><center><?php echo $d->nama_hari.', '.$d->jam; ?></center></td>
                ...
                <br>
                <div align="center" class="card-title">
                    <strong class="text-center">Poliklinik Libur</strong>
                </div>
                <hr>
                <table class="table table-striped">
                  <thead>
                ...
                <tbody>
                    <?php if(empty($datajadwallibur)){ ?>
                        <tr>
                            <td colspan="3"><center><p class="text-danger">Belum ada jadwal poli libur</p></center></td>
                        </tr>
                    <?php }else{ 
                        $no=1; foreach ($datajadwallibur as $d) : ?>
                        <tr>
                            <td><left><p class="text-danger"><?php echo $d->nama_unit.' - '.$d->nama_dokter; ?></p></left></td>
                            <td><center><p class="text-danger"></font><?php echo formatDateIndo($d->tanggal).' (Poli Libur)'; ?></p></center></td>
                        </tr>
                    <?php endforeach ?>
                <?php } ?>
            </tbody>
